...
fmri = FmriQa_Processor(scan_types=['1.2 fmri_179_DYN_2000_TR_SENSE', 'FMRI_TASK', '1.2 fmri_179_DYN_2000_TR_SENSE', '1.2_FMRI_150_DYN_2000_TR_SENSE', 'N-BACK','POSNER','FMRI','FMRI_RESTING','FMRI_VCR','FMRI_NBACK','FMRI_EMOPIC','FMRI_EDP','FMRI_Task','TLT_EPI_1','TLT_EPI_2','TLT_EPI_3','TLT_EPI_4'])
...
myLauncher = Launcher(p, queue_limit=1000, root_job_dir='/gpfs21/scratch/'+os.getlogin()+'/tmp')
